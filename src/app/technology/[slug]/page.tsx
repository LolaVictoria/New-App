...
export default function Page  ({params}: { params: {slug: string}} ) {
  ...
  const TOP_HEADLINES_URL = `https://newsapi.org/v2/everything?q=technology&pageSize=6&from=2024-01-30&sortBy=popularity&page=${pageNumber}&apikey=${process.env.NEXT_PUBLIC_NEWS_KEY}`
    ...
    <div className="">
      ...
      <div className="flex justify-center items-center">
        <div
          ...
          onClick={() => {
            if (pageNumber > 1) {
              router.push(`/technology/${pageNumber - 1}`)
              window.scrollTo(0, 0);
            }
          }}
        >
